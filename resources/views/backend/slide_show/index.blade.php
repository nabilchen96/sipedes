                ...
                <div>
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="mb-2 mb-lg-0">
                            <h3 class="mb-0 fw-bold text-white">Data Slide Show</h3>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <table id="myTable" class="table table-striped" style="width: 100%;">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="bg-info text-white">Gambar</th>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Form Bank</h5>
                        ...
                        <form id="form">
                            <div class="modal-body">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" placeholder="Judul" class="form-control" id="judul" name="judul"
                                        required>
                                </div>
                                <div class="form-group mb-4">
                                    <label>Gambar <sup class="text-danger">*</sup></label>
                                    <input type="file" placeholder="Gambar" class="form-control" id="gambar" name="gambar"
                                        required>
                                </div>
                                <div class="form-group mb-4">
    ...
    <script>
        ...
        function getData() {
            $("#myTable").DataTable({
                ...
                {
                    render: function (data, type, row, meta) {
                        return `<img width="50px" src=/slide_show/${row.gambar}>`
                    }
                },
                {
                    data: "judul"
        ...
        form.onsubmit = (e) => {
            ...
            axios({
                method: 'post',
                url: formData.get('id') == '' ? '/store-slide-show' : '/update-slide-show',
                data: formData,
            })
                .then(function (res) {
                    //handle success         
