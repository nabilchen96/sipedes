    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <select readonly name="status_pegawai" class="form-control" id="status_pegawai" required>
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <select readonly name="pangkat" class="form-control" id="pangkat">
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <input readonly name="nip" id="nip" value="{{ @$profil->nip }}" type="text" placeholder="NIP"
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <input readonly name="email_gov" value="{{ @@$profil->email_gov }}" id="email_gov" type="email"
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <select readonly name="jenis_pegawai" class="form-control" id="jenis_pegawai" required>
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <select readonly name="kedudukan_hukum" class="form-control" id="kedudukan_hukum" required>
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <select readonly name="status_cpns" class="form-control" id="status_cpns" required>
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <input readonly name="kartu_asn_virtual" value="{{ @$profil->kartu_asn_virtual }}" id="kartu_asn_virtual"
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <input readonly name="nomor_sk_cpns" value="{{ @$profil->nomor_sk_cpns }}" id="nomor_sk_cpns" type="text"
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <input readonly name="nomor_sk_pns" value="{{ @$profil->nomor_sk_pns }}" id="nomor_sk_pns" type="text"
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <input readonly name="tmt_golongan" value="{{ @$profil->tmt_golongan }}" id="tmt_golongan" type="date"
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <input readonly name="mk_tahun" id="mk_tahun" value="{{ @$profil->mk_tahun }}" type="number"
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <input readonly name="mk_bulan" id="mk_bulan" value="{{ @$profil->mk_bulan }}" type="number"
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <select readonly name="jenis_jabatan" class="form-control" id="jenis_jabatan" required>
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <input readonly name="lokasi_kerja" id="lokasi_kerja" value="{{ @@$profil->lokasi_kerja }}" type="text"
        ...
        <div class="col-lg-6">
            <div class="form-group">
                <label>Unor </label>
                <input readonly name="unor_nama" id="unor_nama" value="{{ @@$profil->unor_nama }}" type="text"
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <input readonly name="satuan_kerja" id="satuan_kerja" value="{{ @@$profil->satuan_kerja }}" type="text"
