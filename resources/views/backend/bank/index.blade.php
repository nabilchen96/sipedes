                ...
                <div>
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="mb-2 mb-lg-0">
                            <h3 class="mb-0 fw-bold text-white">Data Bank</h3>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <form id="form">
                            <div class="modal-body">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" placeholder="Bank" class="form-control" id="bank" name="bank"
                                        required>
                                </div>
                            </div>
    ...
    <script>
        ...
        $('#modal').on('show.bs.modal', function (event) {
            ...
            if (recipient) {
                ...
                modal.find('#bank').val(cokData[0].bank);
        ...
        form.onsubmit = (e) => {
            ...
            axios({
                method: 'post',
                url: formData.get('id') == '' ? '/store-bank' : '/update-bank',
                data: formData,
            })
                .then(function (res) {
                    //handle success         
